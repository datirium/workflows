...
outputs:
  ...
  fastqc_report_fastq_file_r1:
    type: File
    outputSource: fastqc_fastq_file_r1/html_file
  ...
  fastqc_report_fastq_file_r2:
    type: File
    outputSource: fastqc_fastq_file_r2/html_file
  ...
  trim_adapters_report_fastq_file_r1:
    type: File
    label: "Adapter trimming report for FASTQ file R1"
    doc: "Adapter trimming report for FASTQ file R1"
    outputSource: trim_adapters/report_file

  trim_adapters_report_fastq_file_r2:
    type: File
    label: "Adapter trimming report for FASTQ file R2"
    doc: "Adapter trimming report for FASTQ file R2"
...
steps:
  ...
  fastqc_fastq_file_r1:
    run: ../tools/fastqc.cwl
    in:
      reads_file: extract_fastq_file_r1/fastq_file
      threads: threads
    out:
    - html_file

  fastqc_fastq_file_r2:
    run: ../tools/fastqc.cwl
    in:
      reads_file: extract_fastq_file_r2/fastq_file
      threads: threads
    out:
    - html_file
  ...
  mixcr_shotgun:
    ...
    in:
      ...
      fastq_file:
        source:
        - bypass_trim/selected_fastq_file_1
        - bypass_trim/selected_fastq_file_2
      output_prefix:
        default: "mixcr"
    out:
    - alignment_file
...
s:name: "Repertoire Sequencing Analysis (paired-end)"
...
doc: |
  Repertoire Sequencing Analysis (paired-end)
  ===========================================
  
  Runs MiXCR and VDJTools for analysis of T- and B- cell receptor
  repertoire sequencing data (paired-end)