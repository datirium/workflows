...
s:downloadUrl: https://raw.githubusercontent.com/SciDAP/workflows/master/workflows/xenbase-rnaseq-se.cwl
...
s:about: |
  ...
  4. Align original or trimmed FASTQ file to reference genome, calculate genes and isoforms expression (run RSEM)
