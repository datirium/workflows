...
outputs:
  ...
  strain1_bigwig:
    ...
    outputSource: allele_alignreads_star_se_pe/strain1_bigwig
  ...
  strain2_bigwig:
    ...
    outputSource: allele_alignreads_star_se_pe/strain2_bigwig
  ...
  reference_bigwig:
    ...
    outputSource: allele_alignreads_star_se_pe/reference_bigwig
  ...
  strain1_bambai_pair:
    ...
    outputSource: allele_alignreads_star_se_pe/strain1_bambai_pair
  ...
  strain2_bambai_pair:
    ...
    outputSource: allele_alignreads_star_se_pe/strain2_bambai_pair
  ...
  reference_bambai_pair:
    ...
    outputSource: allele_alignreads_star_se_pe/reference_bambai_pair
  ...
  insilico_star_final_log:
    ...
    outputSource: allele_alignreads_star_se_pe/insilico_star_final_log
  ...
  insilico_star_out_log:
    ...
    outputSource: allele_alignreads_star_se_pe/insilico_star_out_log
  ...
  insilico_star_progress_log:
    ...
    outputSource: allele_alignreads_star_se_pe/insilico_star_progress_log
  ...
  insilico_star_stdout_log:
    ...
    outputSource: allele_alignreads_star_se_pe/insilico_star_stdout_log
  ...
  reference_star_final_log:
    ...
    outputSource: allele_alignreads_star_se_pe/reference_star_final_log
  ...
  reference_star_out_log:
    ...
    outputSource: allele_alignreads_star_se_pe/reference_star_out_log
  ...
  reference_star_progress_log:
    ...
    outputSource: allele_alignreads_star_se_pe/reference_star_progress_log
  ...
  reference_star_stdout_log:
    ...
    outputSource: allele_alignreads_star_se_pe/reference_star_stdout_log
...
steps:
  ...
  allele_alignreads_star_se_pe:
    run: ./allele-alignreads-star-se-pe.cwl
    in:
