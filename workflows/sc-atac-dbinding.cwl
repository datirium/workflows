...
outputs:
  ...
  first_tn5ct_bigwig_file:
    ...
    - igvbrowser:
        ...
        id: 'igvbrowser'
        type: 'wig'
        name: "Tn5 cut sites coverage (first)"
        height: 120
  ...
  second_tn5ct_bigwig_file:
    ...
    - igvbrowser:
        ...
        id: 'igvbrowser'
        type: 'wig'
        name: "Tn5 cut sites coverage (second)"
        height: 120
  ...
  first_enrch_bigbed_file:
    ...
    - igvbrowser:
        ...
        type: 'annotation'
        format: 'bigbed'
        name: "Significant differentially bound sites (first)"
        height: 40
  ...
  second_enrch_bigbed_file:
    ...
    - igvbrowser:
        ...
        type: 'annotation'
        format: 'bigbed'
        name: "Significant differentially bound sites (second)"
        height: 40
