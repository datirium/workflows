  ...
  database_name:
    ...
    doc: |-
      Database details:
       ...
       - Standard (80 GB), Refeq archaea, bacteria, viral, plasmid, human, UniVec_Core - Standard-16 (15 GB), Refeq archaea, bacteria, viral, plasmid, human, UniVec_Core, capped at 16 GB (shrunk via random kmer downselect) - MinusB (9 GB), Standard minus bacteria
