...
steps:
  ...
  preseq:
    ...
    doc: "Estimates the complexity of the sequencing library, evaluates how many reads can\nbe expected from the additional sequencing of the same experiment.  \n"
  ...
  macs2_callpeak:
    ...
    doc: "Identifies enriched with aligned reads genome areas. Those areas correspond to the\ntranscription factor binding sites.  \n"
  ...
  get_bam_statistics:
    ...
    doc: "Calculates alignment statistics, such as reads mapped/unmapped, average\nread length and quality score, etc.  \n"
