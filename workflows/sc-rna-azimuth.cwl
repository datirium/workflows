...
- class: InlineJavascriptRequirement
  ...
  - var get_source_column = function(prefix, reduction, resolution) { if (reduction == "RNA" && resolution != null) { return prefix + "rna_res." + resolution; } else if (reduction == "WNN" && resolution != null) { return prefix + "wsnn_res." + resolution; } else { return null; } };
sd:upstream:
  sc_tools_sample:
  - sc-rna-filter.cwl
