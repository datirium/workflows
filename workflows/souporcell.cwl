...
outputs:
  ...
  gex_genotype_cluster_tsv_file:
    type: File
    outputSource: gex_souporcell/genotype_cluster_tsv_file
  ...
  gex_genotype_cluster_vcf_file:
    type: File
    outputSource: gex_souporcell/genotype_cluster_vcf_file
  ...
  gex_ambient_rna_file:
    type: File
    outputSource: gex_souporcell/ambient_rna_file
  ...
  gex_souporcell_stdout_log:
    type: File
    outputSource: gex_souporcell/stdout_log
  ...
  gex_souporcell_stderr_log:
    type: File
    outputSource: gex_souporcell/stderr_log
  ...
  atac_genotype_cluster_tsv_file:
    type: File
    outputSource: atac_souporcell/genotype_cluster_tsv_file
  ...
  atac_genotype_cluster_vcf_file:
    type: File
    outputSource: atac_souporcell/genotype_cluster_vcf_file
  ...
  atac_ambient_rna_file:
    type: File
    outputSource: atac_souporcell/ambient_rna_file
  ...
  atac_souporcell_stdout_log:
    type: File
    outputSource: atac_souporcell/stdout_log
  ...
  atac_souporcell_stderr_log:
    type: File
    outputSource: atac_souporcell/stderr_log
