...
- class: InlineJavascriptRequirement
  ...
  - var get_query_column = function(prefix, reduction, resolution) { if (reduction=="RNA") { return prefix + "rna_res." + resolution; } else if (reduction=="ATAC") { return prefix + "atac_res." + resolution; } else if (reduction=="WNN") { return prefix + "wsnn_res." + resolution; } };
sd:upstream:
  sc_tools_sample:
  - sc-rna-cluster.cwl
  - sc-atac-cluster.cwl
