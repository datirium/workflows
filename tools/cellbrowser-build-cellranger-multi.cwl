...
inputs:
  ...
  secondary_analysis_report_folder:
    ...
    doc: |
      ...
      cell clustering, and differential expression produced by Cellranger Multi
  ...
  filtered_feature_bc_matrix_folder:
    ...
    doc: |
      ...
      barcodes in MEX format produced by Cellranger Multi
...
label: "Cell Ranger Multi to UCSC Cell Browser"
s:name: "Cell Ranger Multi to UCSC Cell Browser"
s:alternateName: "Exports clustering results from Cell Ranger Multi into compatible with UCSC Cell Browser format"

s:downloadUrl: https://raw.githubusercontent.com/Barski-lab/workflows/master/tools/cellbrowser-build-cellranger-multi.cwl
...
doc: |
  Cell Ranger Multi to UCSC Cell Browser
  
  Exports clustering results from Cell Ranger Multi into
  compatible with UCSC Cell Browser format
